        ...
        <div id="carouselExampleControls" className="carousel slide bs-slider box-slider" data-ride="carousel" data-pause="hover" data-interval="false">
          ...
          <div className="carousel-inner" role="listbox">
            <div className="carousel-item active">
              <div id="home" className="first-section" style={{ backgroundImage: 'url("./asset/images/slider-01.jpg")' }}>
                <div className="dtab">
            ...
            <div className="carousel-item">
              <div id="home" className="first-section" style={{ backgroundImage: 'url("./asset/images/slider-02.jpg")' }}>
                <div className="dtab">
                  <div className="container">
                    <div className="row">
            ...
            <div className="carousel-item">
              <div id="home" className="first-section" style={{ backgroundImage: 'url("./asset/images/slider-03.jpg")' }}>
                <div className="dtab">
                  <div className="container">
                    <div className="row">
